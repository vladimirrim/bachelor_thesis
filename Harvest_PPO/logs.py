...
def plot(data, inds=None, label='data', c=Neon.RED.norm, lw=2, linestyle='-', dashes=None):
    if inds is None:
    ...
    ax = sns.lineplot(inds, data, c=c, linewidth=lw, label=label, linestyle=linestyle, dashes=dashes)
